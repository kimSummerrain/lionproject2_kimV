...
VALUES (1, 1, 100000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 45 DAY), DATE_SUB(NOW(), INTERVAL 45 DAY)),
       (1, 2, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 40 DAY), DATE_SUB(NOW(), INTERVAL 40 DAY)),
       (1, 3, 150000, 3, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 35 DAY), DATE_SUB(NOW(), INTERVAL 35 DAY)),
       (2, 1, 60000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 38 DAY), DATE_SUB(NOW(), INTERVAL 38 DAY)),
       (2, 4, 120000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 32 DAY), DATE_SUB(NOW(), INTERVAL 32 DAY)),
       (4, 1, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 42 DAY), DATE_SUB(NOW(), INTERVAL 42 DAY)),
       (4, 2, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY)),
       (4, 3, 140000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 25 DAY), DATE_SUB(NOW(), INTERVAL 25 DAY)),
       (4, 5, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 20 DAY), DATE_SUB(NOW(), INTERVAL 20 DAY)),
       (5, 2, 40000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_SUB(NOW(), INTERVAL 30 DAY)),
       (5, 3, 80000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 22 DAY), DATE_SUB(NOW(), INTERVAL 22 DAY)),
       (7, 3, 55000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 18 DAY), DATE_SUB(NOW(), INTERVAL 18 DAY)),
       (7, 4, 110000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 15 DAY), DATE_SUB(NOW(), INTERVAL 15 DAY)),
       (8, 4, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 12 DAY), DATE_SUB(NOW(), INTERVAL 12 DAY)),
       (8, 5, 100000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY)),
       (10, 6, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 8 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY)),
       (11, 6, 55000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 6 DAY)),
       (13, 1, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)),
       (14, 2, 55000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)),
       (3, 1, 120000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 50 DAY), DATE_SUB(NOW(), INTERVAL 50 DAY)),
       (3, 2, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 48 DAY), DATE_SUB(NOW(), INTERVAL 48 DAY)),
       (3, 3, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 46 DAY), DATE_SUB(NOW(), INTERVAL 46 DAY)),
       (3, 4, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 44 DAY), DATE_SUB(NOW(), INTERVAL 44 DAY)),
       (3, 5, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 42 DAY), DATE_SUB(NOW(), INTERVAL 42 DAY)),
...
-- 튜토리얼 1에 대한 추가 결제 (리뷰를 위한 데이터)
       (1, 4, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_SUB(NOW(), INTERVAL 30 DAY)),
       (1, 5, 100000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY)),
       (1, 6, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 25 DAY), DATE_SUB(NOW(), INTERVAL 25 DAY)),
       (1, 7, 150000, 3, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 22 DAY), DATE_SUB(NOW(), INTERVAL 22 DAY)),
       (1, 8, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 20 DAY), DATE_SUB(NOW(), INTERVAL 20 DAY)),
       (1, 9, 100000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 18 DAY), DATE_SUB(NOW(), INTERVAL 18 DAY)),
       (1, 10, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 15 DAY), DATE_SUB(NOW(), INTERVAL 15 DAY)),
       (1, 11, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 12 DAY), DATE_SUB(NOW(), INTERVAL 12 DAY)),
       (1, 12, 100000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY)),
-- 튜토리얼 4에 대한 추가 결제
       (4, 6, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 24 DAY), DATE_SUB(NOW(), INTERVAL 24 DAY)),
       (4, 7, 140000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY)),
       (4, 8, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 19 DAY), DATE_SUB(NOW(), INTERVAL 19 DAY)),
       (4, 9, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 16 DAY), DATE_SUB(NOW(), INTERVAL 16 DAY)),
       (4, 11, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY)),
       (4, 12, 140000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 11 DAY), DATE_SUB(NOW(), INTERVAL 11 DAY)),
       (4, 13, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 8 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY)),
       (4, 14, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY)),
-- 튜토리얼 3에 대한 추가 결제
       (3, 6, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 41 DAY), DATE_SUB(NOW(), INTERVAL 41 DAY)),
       (3, 7, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 39 DAY), DATE_SUB(NOW(), INTERVAL 39 DAY)),
       (3, 8, 140000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 37 DAY), DATE_SUB(NOW(), INTERVAL 37 DAY)),
       (3, 9, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 35 DAY), DATE_SUB(NOW(), INTERVAL 35 DAY)),
       (3, 11, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 33 DAY), DATE_SUB(NOW(), INTERVAL 33 DAY)),
       (3, 12, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 31 DAY), DATE_SUB(NOW(), INTERVAL 31 DAY)),
       (3, 13, 140000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 29 DAY), DATE_SUB(NOW(), INTERVAL 29 DAY)),
       (3, 14, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 27 DAY), DATE_SUB(NOW(), INTERVAL 27 DAY)),
-- 다른 튜토리얼들에 대한 추가 결제
       (2, 6, 60000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_SUB(NOW(), INTERVAL 30 DAY)),
       (2, 7, 120000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 27 DAY), DATE_SUB(NOW(), INTERVAL 27 DAY)),
       (5, 6, 40000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY)),
       (5, 7, 80000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 25 DAY), DATE_SUB(NOW(), INTERVAL 25 DAY)),
       (7, 5, 55000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 20 DAY), DATE_SUB(NOW(), INTERVAL 20 DAY)),
       (7, 6, 110000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 17 DAY), DATE_SUB(NOW(), INTERVAL 17 DAY)),
       (8, 6, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY)),
       (8, 7, 100000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 11 DAY), DATE_SUB(NOW(), INTERVAL 11 DAY)),
-- 다양한 상태의 결제 추가 (상태별 필터링 테스트용)
       (1, 15, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 20 DAY), DATE_SUB(NOW(), INTERVAL 20 DAY)),
       (2, 15, 60000, 1, 'REFUNDED', NOW(), DATE_SUB(NOW(), INTERVAL 18 DAY), DATE_SUB(NOW(), INTERVAL 15 DAY)),
       (4, 15, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 16 DAY), DATE_SUB(NOW(), INTERVAL 16 DAY)),
       (4, 16, 140000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY)),
       (5, 16, 55000, 1, 'REFUNDED', NOW(), DATE_SUB(NOW(), INTERVAL 12 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY)),
       (7, 15, 55000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY)),
       (8, 15, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 8 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY)),
       (10, 15, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 6 DAY)),
       (11, 16, 55000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)),
       (13, 15, 50000, 1, 'REFUNDED', NOW(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)),
       (1, 16, 100000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 25 DAY), DATE_SUB(NOW(), INTERVAL 25 DAY)),
       (2, 17, 60000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 23 DAY), DATE_SUB(NOW(), INTERVAL 23 DAY)),
       (4, 17, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY)),
       (5, 17, 80000, 2, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 19 DAY), DATE_SUB(NOW(), INTERVAL 19 DAY)),
       (7, 16, 55000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 17 DAY), DATE_SUB(NOW(), INTERVAL 17 DAY)),
       (8, 17, 50000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 15 DAY), DATE_SUB(NOW(), INTERVAL 15 DAY)),
       (10, 16, 70000, 1, 'PAID', NOW(), DATE_SUB(NOW(), INTERVAL 13 DAY), DATE_SUB(NOW(), INTERVAL 13 DAY)),
