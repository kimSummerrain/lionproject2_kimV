...
export default function Footer() {
  return (
    <footer className="py-12 border-t border-slate-200 dark:border-slate-800 px-4 bg-slate-50 dark:bg-slate-900/50">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        <div className="col-span-2">
          ...
          <p className="text-slate-500 max-w-md mb-6 leading-relaxed">
            실제 프로젝트 경험과 깊이 있는 기술력을 가진 멘토들과 함께 당신의 개발
            커리어를 한 단계 더 높여보세요.
          </p>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400">
        <p>© 2024 DevSolve Inc. All rights reserved.</p>
        <div className="flex gap-6">
          <a href="#" className="hover:text-slate-600 dark:hover:text-slate-200">
            개인정보처리방침
          </a>
          <a href="#" className="hover:text-slate-600 dark:hover:text-slate-200">
            운영정책
